...
const resources = {
  he: {
    translation: {
      ...
      originSearchPlaceholder: "מאיפה יוצאים?",
      currentLocation: "המיקום הנוכחי",
      origin: {
        label: "נקודת התחלה",
        change: "שינוי נקודת התחלה",
        useCurrent: "יציאה מהמיקום שלי",
      },
      departure: {
        label: "יציאה",
        arriveLabel: "הגעה",
        now: "יציאה עכשיו",
        change: "שינוי זמן הנסיעה",
        choose: "תכנון זמן הנסיעה",
        leaveAt: "יציאה ב־",
        arriveBy: "הגעה עד",
        pick: "בחירת תאריך ושעה",
        done: "בחירה",
      },
      ...
      routeComparisonHint:
        "בחרו מסלול להשוואה על המפה. הנתונים מוצגים לאותו זמן מתוכנן.",
  ...
  en: {
    translation: {
      ...
      originSearchPlaceholder: "Where from?",
      currentLocation: "Current location",
      origin: {
        label: "Starting point",
        change: "Change starting point",
        useCurrent: "Start from my location",
      },
      departure: {
        label: "Leave",
        arriveLabel: "Arrive",
        now: "Leave now",
        change: "Change trip time",
        choose: "Plan trip time",
        leaveAt: "Depart at",
        arriveBy: "Arrive by",
        pick: "Choose date and time",
        done: "Done",
      },
      ...
      routeComparisonHint:
        "Select a route to compare it on the map. Metrics use the same planned time.",
